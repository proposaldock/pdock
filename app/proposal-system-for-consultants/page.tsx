...
export const metadata: Metadata = {
  ...
  description:
    "A practical proposal system for consultants with structured brief intake, requirement review, reusable approved knowledge, review-ready drafts, and export.",
  alternates: {
  ...
  openGraph: {
    title: "Proposal System for Consultants | ProposalDock",
    description:
      "Learn what a proposal system for consultants should include, from structured intake and requirement review to approved knowledge and export.",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mt-10 border-b border-zinc-200 pb-10">
          ...
          <p className="mt-5 max-w-3xl text-base leading-8 text-zinc-700">
            ...
            when the brief is messy, requirements are unclear, proof is scattered, and review
